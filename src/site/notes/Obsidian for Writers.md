---
{"dg-publish":true,"dg-path":"obsidian-for-writers","permalink":"/obsidian-for-writers/","tags":["project"],"noteIcon":"","updated":"2026-07-08T09:01:27.491+01:00","dg-note-properties":{"start":"2026-05-01","due":"2026-06-21","up":["[[Projects]]"],"tags":["project"],"state":"promoting"}}
---
...
There's a line from David Allen's seminal text on productivity, _Getting Things Done_ that, whether or not people know it, is always in the background of any conversation on writing: which is, "Your mind is for having ideas, not holding them."
...
- notes software
- google docs
- and so on, all accessible through a web browser, perfectly backed up in case of had disk crash, laptop theft or even acts of god.
...
- Collaboration tools
- Discord bots
- Editors of all kinds including the ones you might already be using, such as VSCode
- Offline Grammar and spellcheckers that DON'T train AI on your words
- Tools for joining and splitting files into chapters or by speaker or topic or location
...
- Statuses
- Scenes
- some of which can have metadata attached
...
- Linter
    - What's better than a style guide? A style guide that corrects you automatically when you save!
- wordy
    - A combination of Thesaurus, Rhyming dictionary, Alteration lookup, and a Dictionary
- hotkeys for templates
    - If you regularly type the same thing over and over again, perhaps scene direction or an editing checklist, then you should certainly use the built-in templater plugin. And if you find you use certain templates very frequently, you may wish to make a hotkey for it!
- BRIEFLY: base / dataview / tasks
    - The power and beauty of Obsidian is that while the entry-level complexity is extremely low (it can be used only as a plain text notepad if you wish) there are no upper limits to how complex you may make it.
    - Built in tools such as Bases and Canvas hint at this, but the ecosystem of plugins shows just how flexible plain text is. For the writer, none is more obvious than the last plugin I will mention: Storyline
- Storyline
...
- On Windows and Linux it is `c-p`
- On Mac it's `cmd=p`; 'p' for pallette
...
- Pandoc https://community.obsidian.md/plugins/obsidian-pandoc
