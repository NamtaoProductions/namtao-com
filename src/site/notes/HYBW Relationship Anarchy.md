---
{"dg-publish":true,"dg-path":"relationship-anarchy","permalink":"/relationship-anarchy/","tags":["project/nb"],"noteIcon":"","updated":"2026-07-03T13:34:43.000+01:00","dg-note-properties":{"start":"2026-05-09","due":"2026-05-15","up":["[[Projects/No Boilerplate Index]]"],"tags":["project/nb"],"state":"done"}}
---
...
```mermaid
classDiagram
    class Emotional-Intimacy {
        Sharing vulnerability
        Confidante
        Words of affection
    }
    class Physical-Intimacy {
        Cuddling
        Kissing
        Hand-holding
    }
    class Sexual-Intimacy {
        Sexual acts
        Sexual talk
        Kissing
    }
...
```mermaid
classDiagram
    class Collaberative-Partnership {
        Artistic
        Business
        Teaching
    }
    ...
    class Voluntary-Asymmetry {
        Sponsor/sponsee
        Mentor/guide
        Guardian/ward
    }
    class Social-Partnership {
...
classDiagram
    ...
    class Physical-Intimacy:::alice {
        Cuddling
        Kissing
        Hand-holding
    }
    class Sexual-Intimicy {
        Sexual acts
        Sexual talk
        Kissing
    }
    class Companionship:::alice {
        Playfulness
        Shared activity/interests
        Friendship
    }
...
classDiagram
    ...
    class Social-Partnership:::alice {
        Public displays of affection
        Sharing social circles
        Presenting as a social unit
    }
...
```mermaid
classDiagram
    class Emotional-Intimacy:::alice {
        Sharing vulnerability
        Confidante
        Words of affection
    }
...
classDiagram
    class Long-term-partnership:::alice {
        Shared future goals
        Commitment
        Chosen family
    }
...
classDiagram
    ...
    class Caregiving:::alice {
        Receiving care
        Giving care
        Emergency contact
    }
    class Co-caregiving:::alice {
        Sick, disabled, elderly
        Adults
        Children/animals/plants
    }
    class Entanglement:::alice {
        Cohabitation
        Finances/legal
        Routines & chores
    }
...
```mermaid
classDiagram
    class Collaberative-Partnership:::alice {
        Artistic
        Business
        Teaching
    }
    ...
    class Voluntary-Asymmetry:::alice {
        Sponsor/sponsee
        Mentor/guide
        Guardian/ward
    }
