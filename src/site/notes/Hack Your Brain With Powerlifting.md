...
```mermaid
flowchart TD
    lift20(Can you lift an empty 20kg barbell safely?)
    lift15(Can you lift an empty 15kg barbell safely?)
    start(Start powerlifting!)
    pt(Talk to a PT about your individual fitness journey)
    couch2(Can you complete 'Couch to Barbell' safely?)
 
    lift20==>|yes|start
    lift20-.->|no|lift15==>|yes|start
    lift15-.->|no|couch2
    couch2-.->|no|pt
    couch2==>|Yes|start
