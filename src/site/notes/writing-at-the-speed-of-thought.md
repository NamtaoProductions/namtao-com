---
{"dg-publish":true,"permalink":"/writing-at-the-speed-of-thought/","tags":["project/nb"],"noteIcon":"","created":"2025-01-27T08:53","updated":"2025-05-09T17:12"}
---
...
> [!IMPORTANT] Education is a battleground
...
This all begs the question: "If Most Writing is Rewriting, why Isn't there  dedicated Editing Mode on our keyboards?"
...
![image:width:70%](/img/user/Resources/Meta/attachments/tektronic-410-terminal.png)

In 1972, $30,000 (equivalent) didn't even get you arrow keys.

---
<!-- skip_slide -->

Hi folks, thank you so much for supporting me. I cut a little history lesson and some background from the main script for being 'too nerdy for normies', but I think you all might be interested:

Vi, the visual editor, ancestor to vim and Neovim, almost accidentally developed the marvellous way of editing text that I'm gently encouraging the viewer towards with this video.

Back when computers were expensive things that lived in your university's basement, users often interacted with them using a remote serial terminal, either by direct network link or over the phone lines using a modem.
These 'dumb terminals' were little more than a keyboard and a screen - with only enough computing power to encode and decode text and send it down the line.

In the early days, there was no keyboard standardisation for these 'dumb terminal' machines, even whether or not they had arrow keys could not be guaranteed.

Vi's ingenious solution was to only use printable letters, numbers, and occasional symbols to edit all text, arrow keys included.

And that is how we got HJKL.

---

<!-- alignment: center -->
<!-- new_lines: 2 -->
![](/img/user/Resources/Meta/attachments/photoshop-keyboard-cover.png)

<!-- new_lines: 2 -->
<!-- alignment: right -->
Image credit: Editorkeys.com

---
<!-- skip_slide -->
 

Also, have you ever seen someone doing video, photo, or audio editing using a multicoloured keyboard like this?
These layers or stickers cleverly show you the hotkeys available inside the app for doing common tasks like moving clips around or switching between tools.

A slight annoyance is that each program has different hotkeys, of course. (Stay tuned for my solution!)
...
![](/img/user/Resources/Meta/attachments/violin-with-frets.png)

---
<!-- skip_slide -->
 

As it's just us, I'll get even more personal:
I am a multiinstrumentalist, which is to say: I play 10 musical instruments BADLY.

I can only keep up even my bad competence in all these because NONE of the instruments I have chosen require much muscle memory to play.
My brain seems to be able to remember the skills I need, but my fingers - my muscle memory - requires constant practice to keep up.
And that is much more difficult on some instruments than others:

So, I can play guitar but not violin.
Trumpet, but not trombone.
Bass but not double bass
Piano but not, I guess, Theremin.
 

Instruments that have a continuously variable scale require you to train your muscles to stop at the right points.
I don't have time for that. And hte reason I'm telling you will become clear when I talk about a unified hotkey system, across all apps.
...
![](/img/user/Resources/Meta/attachments/Vim-logo.png)
...
Remember why we're doing all this: Speed up your editing, speed up your thinking.
